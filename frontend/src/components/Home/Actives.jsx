...
const Actives = ({ project }) => {
    ...
    // console.log("currentMem",currentMember)
    const role = currentMember?.role || "N/A";

    return (
        <div className="relative w-full h-full min-w-[380px] flex flex-col border-2 border-black p-4 rounded-lg shadow-md">
            <div className="w-full flex justify-between border-b border-black pb-2 mb-4">
                <h1 className="text-sm font-semibold font-sans">{project_name}</h1>
            ...
            <p className="text-sm text-gray-700 text-wrap w-[64%]">{`Description: ${descp}`}</p>
